    ...
    return (
        <View style={styles.container}>
            ...
            <ScrollView contentContainerStyle={styles.content}>
                <Text style={styles.welcomeText}>Jaquetas</Text>
                
                <View style={styles.detalheprodutocontainer}>
                    <Image source={require('../../assets/jaqueta.png')} style={styles.produtoImage} />
                    <Text style={styles.detalheprodutoText}>Detalhes sobre as jaquetas...</Text>
                </View>
            </ScrollView>
        </View>
    );
...
export default JaquetasUsuario;
