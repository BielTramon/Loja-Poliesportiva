    ...
    return (
        <View style={styles.container}>
            ...
            <ScrollView contentContainerStyle={styles.content}>
                <Text style={styles.welcomeText}>Meias</Text>
                
                <View style={styles.detalheprodutocontainer}>
                    <Image source={require('../../assets/meia.png')} style={styles.produtoImage} />
                    <Text style={styles.detalheprodutoText}>Detalhes sobre as meias...</Text>
                </View>
            </ScrollView>
        </View>
    );
