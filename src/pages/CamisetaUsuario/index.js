    ...
    return (
        <View style={styles.container}>
            ...
            <ScrollView contentContainerStyle={styles.content}>
                <Text style={styles.welcomeText}>Camisetas</Text>
                
                <View style={styles.detalheprodutocontainer}>
                    <Image source={require('../../assets/camiseta.png')} style={styles.produtoImage} />
                    <Text style={styles.detalheprodutoText}>Detalhes sobre as camisetas...</Text>
                </View>
            </ScrollView>
        </View>
    );
...
export default CamisetaUsuario;
