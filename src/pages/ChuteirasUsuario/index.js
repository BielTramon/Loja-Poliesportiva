    ...
    return (
        <View style={styles.container}>
            ...
            <ScrollView contentContainerStyle={styles.content}>
                <Text style={styles.welcomeText}>Chuteiras</Text>
                
                <View style={styles.detalheprodutocontainer}>
                    <Image source={require('../../assets/chuteira.png')} style={styles.produtoImage} />
                    <Text style={styles.detalheprodutoText}>Detalhes sobre as chuteiras...</Text>
                </View>
            </ScrollView>
        </View>
    );
...
export default ChuteirasUsuario;
